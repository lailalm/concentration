        ...
        if (cardButtons != nil) {
            for index in cardButtons.indices {
                ...
                if card.isFacedUp {
                    ...
                    button.backgroundColor = card.isMatched ? #colorLiteral(red: 0.9411764741, green: 0.4980392158, blue: 0.3529411852, alpha: 0) : #colorLiteral(red: 0, green: 0.5898008943, blue: 1, alpha: 1)
                }
            }
        }
    }
